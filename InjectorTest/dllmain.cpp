...
public:
	...
	__declspec(noinline)
	static void TestHook(HWND hWnd, LPCTSTR lpText, LPCTSTR lpCaption, unsigned short uType, int iReturnedValue)
	{
	...
	void OnLoad() override
	{
		try
		{
			...
			std::cout << reinterpret_cast<LPVOID>(*pFunc) << std::endl << MessageBoxW << std::endl;
